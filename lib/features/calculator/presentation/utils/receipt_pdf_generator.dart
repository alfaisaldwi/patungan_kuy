...
class ReceiptPdfGenerator {
          ...
          build: (ctx) => [
            ...
            ...result.calculatedBills.map((bill) {
              ...
              return _personSection(
                bill.name,
                order.isNotEmpty ? order.first.items : const <OrderItem>[],
                bill,
              );
            }),
            ...
            pw.Center(
              child: pw.Text(
                'Dibuat pakai PatunganKuy - Patungan? Kuy!',
  ...
  static pw.Widget _summaryCard(BillResult result) {
    return pw.Container(
      ...
      child: pw.Column(
        children: [
          _row('Subtotal', result.totalBase),
          _row('Total Biaya', result.totalFees),
          _row('Total Diskon', -result.totalDiscount),
          pw.Padding(
  ...
  static pw.Widget _personSection(
    String name,
